package core.fortune.voronoi;// the voronoi diagram (a set of edges) for a set of points (sites)
...
public class Voronoi {
    ...
    public final List<Edge> edges; // edges on Voronoi diagram
    ...
    public static Voronoi gen(int n) {
